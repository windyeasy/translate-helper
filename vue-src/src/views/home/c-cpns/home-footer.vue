...
<template>
  <footer class="footer flex items-center justify-between p-3">
    <div class="footer-left flex">
      <img src="@/assets/logo.svg" class="app-icon w-[20px] h-[20px]"></img>
      <div class="app-name ml-2">TranslateHelper</div>
    </div>
